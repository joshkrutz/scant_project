...
exports.seed = async function(knex) {
  ...
  await knex('player_node').insert([
    ...
    { name: 'SSC_AA', description:'LAUNCH',clearance: 'TS/SCI/no foreign',location_id:'3',risk_rating:'1',risk_description: 'FAA and Big Space Force watches them like HAWKS',affiliation:'GOV USSF SSC',image_url: 'https:notavaible'},
